...
#'   `condo_info_2010` is created.
#' @return a `tibble`
#' @importFrom readr read_csv
#' @importFrom janitor clean_names
#' @export
make_condo_info_2010 <- function(dl_parcel_data){

  dl_parcel_data # ignore

  condo_info_2010 <- readr::read_csv("extdata/kc-assessor-parcels-2005-2010-2018/EXTR_Condo_Unit_2010.csv") %>%
