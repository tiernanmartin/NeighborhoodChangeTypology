...
make_model_table <- function(){
  ...
  "BATES",      "VULNERABILITY",     "PERCENT",           "RACE",      "ACS",    2016L,
  "BATES",      "VULNERABILITY",     "PERCENT",      "EDUCATION",      "ACS",    2016L,
  "BATES",      "VULNERABILITY",     "PERCENT",         "TENURE",      "ACS",    2016L,
  "BATES",      "VULNERABILITY",     "PERCENT",         "INCOME",     "CHAS",    2015L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",           "RACE",      "ACS",    2011L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",      "EDUCATION",      "ACS",    2011L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",         "TENURE",      "ACS",    2011L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",         "INCOME",     "CHAS",    2010L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",           "RACE",      "ACS",    2016L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",      "EDUCATION",      "ACS",    2016L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",         "TENURE",      "ACS",    2016L,
  "BATES", "DEMOGRAPHIC CHANGE",     "PERCENT",         "INCOME",      "ACS",    2016L,
  "BATES",     "HOUSING MARKET",       "VALUE",          "VALUE",     "LTDB",    2000L,
  "BATES",     "HOUSING MARKET",       "VALUE",          "VALUE",      "ACS",    2010L,
  "BATES",     "HOUSING MARKET",       "VALUE",          "VALUE",      "ACS",    2016L,
