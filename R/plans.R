...
get_data_source_plan <- function(){
  ...
  prep_plan <- drake::drake_plan(
    ...
    parcel_boundaries_prep_status = target(prepare_parcel_boundaries(path = file_out("extdata/source/parcel_SHP.zip")),
                                           trigger = trigger(mode = "condition", condition = FALSE)),
    parcel_data_prep_status = target(prepare_parcel_data(model_table, acs_tables, zip_path = file_out("extdata/source/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip")),
                                     trigger = trigger(mode = "condition", condition = FALSE)),
  ...
  upload_plan <- drake::drake_plan(
    ...
    parcel_data_upload_status = target(osf_upload_or_update(has_osf_access = has_osf_access,
                                                            project_id = "sj7n9",
                                                            file_id = "9t5vc",
                                                            path = file_in("extdata/source/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip")),
                                       trigger = trigger(command = FALSE)),
...
get_data_cache_plan <- function(){
  ...
  download_plan <- drake::drake_plan(
    ...
    parcel_data_filepath = target(command = osf_download_files(id = "9t5vc", path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip")),
                                  trigger = trigger(change = get_osf_version("sj7n9", "kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"))),
  ...
  ready_plan <- drake::drake_plan(
    ...
    parcel_value =  make_parcel_value(data_template,
                                      zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                      file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ValueHistory_V.csv")),
    parcel_sales =  make_parcel_sales(data_template,
                                      zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                      file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_RPSale.csv")),
    parcel_info_2005 = make_parcel_info_2005(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2005.csv")),
    parcel_info_2010 = make_parcel_info_2010(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2010.csv")),
    parcel_info_2015 = make_parcel_info_2015(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2015.csv")),
    parcel_info_2016 = make_parcel_info_2016(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2016.csv")),
    parcel_info_2017 = make_parcel_info_2017(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2017.csv")),
    parcel_info_2018 = make_parcel_info_2018(metadata_template,
                                             zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                             file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Parcel_2018.csv")),
    parcel_lut_2005 = make_parcel_lut_2005(metadata_template,
                                           zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                           file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_LookUp_2005.csv")),
    parcel_lut_2018 = make_parcel_lut_2018(metadata_template,
                                           zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                           file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_LookUp_2018.csv")),
    condo_info_2005 =  make_condo_info_2005(metadata_template,
                                            zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                            file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Condo_Unit_2005.csv")),
    condo_info_2010 =  make_condo_info_2010(metadata_template,
                                            zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                            file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Condo_Unit_2010.csv")),
    condo_info_2015 =  make_condo_info_2015(metadata_template,
                                            zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                            file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_Condo_Unit_2015.csv")),
    condo_info_2017 =  make_condo_info_2017(metadata_template,
                                            zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                            file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_CondoUnit2_2017.csv")),
    condo_info_2018 =  make_condo_info_2018(metadata_template,
                                            zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                            file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_CondoUnit2_2018.csv")),
    res_bldg_2005 = make_res_bldg_2005(metadata_template,
                                       zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                       file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ResBldg_2005.csv")),
    res_bldg_2010 = make_res_bldg_2010(metadata_template,
                                       zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                       file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ResBldg_2010.csv")),
    res_bldg_2015 = make_res_bldg_2015(metadata_template,
                                       zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                       file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ResBldg_2015.csv")),
    res_bldg_2017 = make_res_bldg_2017(metadata_template,
                                       zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                       file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ResBldg_2017.csv")),
    res_bldg_2018 = make_res_bldg_2018(metadata_template,
                                       zip_path = file_in("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018.zip"),
                                       file_path = file_out("extdata/osf/kc-assessor-parcels-2005-2010-2015-2016-2017-2018/EXTR_ResBldg_2018.csv")),
...
get_variable_plan <- function(){
  ...
  var_plan <- drake::drake_plan(
    ...
    parcel_sales_variables = make_parcel_sales_variables(parcel_sales,
                                                         ...
                                                         cpi,
                                                         variable_template),
    parcel_value_variables = make_parcel_value_variables(parcel_all_metadata,
                                                         single_family_criteria,
                                                         condo_criteria,
                                                         cpi,
                                                         parcel_value,
